...
# Frontend S3 Bucket
resource "aws_s3_bucket" "tfer--dugout-frontend-test" {
  bucket        = "dugout-frontend-test"
  force_destroy = false

  object_lock_enabled = false

  tags = {
    Name = "dugout-frontend-test"
  }
}
...
resource "aws_s3_bucket_public_access_block" "tfer--dugout-frontend-test" {
